...
%\newcommand{\thesistitle}{Effektivit\"{a}tsanalyse\\ \vspace{-0.15cm}des \textit{c}-Collision Protokolls}
%\newcommand{\thesissubtitle}{\vspace{-0.15cm}als gewichteter Datenbalancierer\\ \vspace{-0.15cm}in einem parallelen\\ \vspace{-0.15cm}Out-of-Core Renderer}
...
\newcommand{\institut}{Institut f\"{u}r Informatik}
...
% make boldfaced caption-ids, and justification left
\usepackage[bf,font=footnotesize,justification=raggedright,singlelinecheck=false]{caption}
\addtokomafont{captionlabel}{\textbf}

% making the captions kursive/slanted
...
\advance\oddsidemargin by 2.1cm
...
% Selbentrennung
% ---------------------------------------------------------------------------
\hyphenation{Bild-ra-ten Mo-dell Mo-dells Mo-del-le Spei-cher-ver-wal-tung ge-o-me-tri-e pa-ral-lel pa-ral-le-len Ope-ra-ti-on Ope-ra-ti-o-nen Ap-pro-xi-ma-ti-on ent-sprech-en-den Netz-werk er-reicht Ren-de-rer Ren-de-ring Da-ten-kno-ten Pro-ceed-ings ap-pli-ca-tions Boeing Bild-er-zeu-gung Cache Loose Sys-tem}
...
\def\chapter#1{\cleardoublepage\oldchapter{#1}}
