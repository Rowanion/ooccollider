...
\acro{KD-Baum}{Ein k-dimensionaler Baum oder KD-Baum ist ein unbalancierter Suchbaum zur Speicherung von Punkten.}
\acro{LOD}{Level-Of-Detail \cite{RTR3}}
\acro{PLP}{Prioritized-Layered Projection \cite{plp}}
\todo[inline]{@Tim: Octree/KD-Baum definition in ordnung so?!}
...
\acro{PVS}{Potentially Visible Set \cite{RTR3}}
