...
\todo[size=\small, inline]{Genaue Herkunft des Boeing-Modells finden $\rightarrow$ von Boeing selbst, Bildunterschrift kommt\dots am Donnerstag?!}%
...
\end{figure}
\missingfigure{Bild zum Loose Octree $\rightarrow$ siehe neustes Bookmark}
