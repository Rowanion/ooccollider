...
\begin{figure}
 ...
 % octree.pdf: 640x368 pixel, 72dpi, 22.58x12.98 cm, bb=0 0 640 368
  \caption[Ein Octree]{Ein Octree der Tiefe 2. Links: die räumliche Darstellung, rechts: die Baumdarstellung. Quelle:\mycite{wikioctree}}
...
\begin{figure}
 \centering
  ...
  \caption[Ein Loose Octree]{Ein Loose Octree in einer 2D-Darstellung. Das Zentrum des Objekts (rosa) befindet sich innerhalb der Octree Zelle, das gesamte Objekt befindet sich innerhalb der Loose Box. Quelle: nach\mycite{anteru}}
...
\begin{figure}
 \centering
  ...
  \caption[Ein Sampletree]{Ein Sampletree in einer 2D-Darstellung. Links: eine Aufteilung von Polygonen in verschiedene Quadtree Zellen, rechts: die Baumdarstellung des Sampletrees. Die farbigen Knoten geben an, welche Polygonteile der linken Seite in welchem Baum-Level gespeichert wurden. Quelle: nach\mycite{klein}}
...
\begin{figure}
  ...
  \caption[Culling-Techniken]{Verschiedene Culling-Techniken. Teile der Geometrie, die durch den Einsatz von Culling-Algorithmen entfallen würden, sind durch gestrichelte Linien dargestellt. \textit{Quelle: nach\mycite{culling}} }
