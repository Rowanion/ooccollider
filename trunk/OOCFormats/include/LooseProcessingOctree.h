...
class LooseProcessingOctree
{
	...
	public:
		LooseProcessingOctree(LooseProcessingOctree* _father, const ooctools::BoundingBox& _bb, std::string _path);
		...
		virtual bool isRoot();
		bool isEmpty();
		virtual ooctools::BoundingBox subdivideFne();
		virtual ooctools::BoundingBox subdivideFnw();
		virtual ooctools::BoundingBox subdivideFse();
		virtual ooctools::BoundingBox subdivideFsw();
		virtual ooctools::BoundingBox subdivideBne();
		virtual ooctools::BoundingBox subdivideBnw();
		virtual ooctools::BoundingBox subdivideBse();
		virtual ooctools::BoundingBox subdivideBsw();
