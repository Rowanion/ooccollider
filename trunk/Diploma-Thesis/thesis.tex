...
\newcommand{\institut}{Heinz-Nixdorf-Institut}
\newcommand{\institutsuni}{Universität Paderborn} % disabled by default
\newcommand{\betreuer}{o.Dipl.-Inf. Dr. Matthias Fischer}
\newcommand{\assistent}{Univ.-Ass. Dipl.-Inf. Tim Süß}
...
\documentclass[%
  ...
  %liststotoc,
  liststotocnumbered,
  halfparskip,%         Europäischer Satz mit abstand zwischen AbsÃ¤tzen
...
\input{chapters/appendix-diagrams}
